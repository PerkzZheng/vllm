...
Install vLLM's matching native extensions with its editable/precompiled build.
The dedicated Qwen image supplies FlashInfer GDN/MoE modules. Replacing the
complete FlashInfer package would hide those
